...
**Your readers are experts who know the field and the topic.** Describe your interests using the terminology and framing a scientist in the field would, to demonstrate that you know your stuff. Drop the names of people who worked with who they might know. And name them in your last paragraph! 
...
- A personal statement can also be a space to explain a break from schooling, a gap in your transcript, etc, framing it again as a growth/overcoming adversity experience. I have actually not tried doing this myself, so I’m not sure how this actually looks or how to do it, but this is definitely a thing you can do! Another idea to have a rec letter writer to cover this in their rec letter, which could be another space to address that in your application. 
...
- Read your statement out loud to yourself (or use the Review > "Read Aloud" feature in Microsoft Word), so your ears can freshly catch what your eyes have grown used to. You might catch jumps in the narrative flow, or clunky sentences. Notice if you spontaneously correct or change anything on the fly - consider whether to change the writing to match! 
- 
